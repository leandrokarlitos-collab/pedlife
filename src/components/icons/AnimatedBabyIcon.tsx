...
export const AnimatedBabyIcon = ({ className }: { className?: string }) => {
  return (
    <svg 
      viewBox="0 0 24 24" 
      fill="none" 
    ...
    >
      ...
      <g className="face-features transition-transform duration-300 group-hover:-translate-y-0.5">
        ...
        <g className="mouth-animation">
          ...
          <path d="M8.5 16C8.5 16 10 19.5 12 19.5C14 19.5 15.5 16 15.5 16C15.5 16 14 17.5 12 17.5C10 17.5 8.5 16 8.5 16Z" fill="currentColor" className="text-premium-violet opacity-0 transition-all duration-300 scale-90 group-hover:opacity-100 group-hover:scale-110 origin-center"/>
        </g>
      </g>
    </svg>
  );
