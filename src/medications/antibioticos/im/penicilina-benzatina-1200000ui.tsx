/**
 * Penicilina Benzatina 1.200.000 UI - Pó para Suspensão Injetável IM
 */

import { MedicamentoData, MedicamentoExport, ResultadoCalculo } from '../../types';

export const data: MedicamentoData = {
  id: 'penicilina-benzatina-1200000ui',
  nome: 'Penicilina Benzatina 1.200.000 UI',
  nomesComerciais: ['Benzetacil'],
  viaAdministracao: 'IM',
  formaFarmaceutica: 'Pó para Solução Injetável',
  classe: {
    nome: 'Penicilina de depósito',
    descricao: 'Antibiótico de ação prolongada',
  },
  ...
  doseUsualTexto: 'Para pacientes ≥ 27 kg: 1.200.000 UI (dose única)',
  doseMinima: '1.200.000 UI',
  doseMaxima: '1.200.000 UI',
  parametrosCalculo: {
...
export function calcularDose(peso: number): ResultadoCalculo {
  ...
  if (peso < 27) {
    alertas.push('Peso < 27 kg: usar apresentação de 600.000 UI');
  }

  return {
    doseCalculada: '1.200.000 UI',
    volumeCalculado: '4 mL (volume total do frasco)',
    unidade: 'mL',
    intervalo: 'Dose única',
    observacoes: [
      'Reconstituir com 4 mL de Água Destilada',
