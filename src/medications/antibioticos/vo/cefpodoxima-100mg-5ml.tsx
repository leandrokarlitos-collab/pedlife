/**
 * Cefpodoxima 100 mg/5 mL - Suspensão Oral
 */

import { MedicamentoData, MedicamentoExport, ResultadoCalculo } from '../../types';

export const data: MedicamentoData = {
  id: 'cefpodoxima-100mg-5ml',
  nome: 'Cefpodoxima 100 mg/5 mL',
  ...
  doseUsualTexto: '10 mg/kg/dia 12/12h',
  ...
  observacoes: 'Alta concentração. Ingerir com alimentos.',
