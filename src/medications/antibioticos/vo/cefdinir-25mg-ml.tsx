/**
 * Cefdinir 25 mg/mL - Suspensão Oral
 */
...
export const data: MedicamentoData = {
  ...
  parametrosCalculo: {
    ...
    formulaCalculo: 'Peso (kg) × 0,28 mL 12/12h',
  },
  restricaoIdade: { idadeMinima: '≥ 6 meses' },
  observacoes: 'Pode ser administrado com ou sem alimentos. Pode alterar cor das fezes para vermelho.',
