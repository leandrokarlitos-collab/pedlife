/**
 * Ibuprofeno 100 mg/mL - Gotas
 */

import { MedicamentoData, MedicamentoExport, ResultadoCalculo } from '../../types';

export const data: MedicamentoData = {
    id: 'ibuprofeno-100mg-ml-gotas',
    nome: 'Ibuprofeno 100 mg/mL (Gotas)',
    ...
    parametrosCalculo: {
        ...
        formulaCalculo: '0,5 a 1 gota por kg de peso (1 mL = 10 gotas)',
    },
    restricaoIdade: {
        idadeMinima: '≥ 6 meses',
    },
...
export function calcularDose(peso: number, idade?: number): ResultadoCalculo {
    ...
    const numGotas = Math.round(peso * 0.5); // 0.5 gota por kg
    ...
    return {
        ...
        observacoes: ['Administrar após refeições'],
        alertas,
    };
}
